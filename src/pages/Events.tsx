...
const events: Event[] = [
  {
    ...
    price: 750,
    capacity: 200,
    description: 'Annual jazz festival featuring local and international artists. Experience world-class performances across multiple stages.',
    ageRestriction: '18+',
    category: 'Music',
  ...
  },
  {
    ...
    price: 1200,
    capacity: 150,
    description: 'Explore the finest wines and cuisine of the Cape Winelands. Includes wine tasting, gourmet food pairings, and live entertainment.',
    ageRestriction: '18+',
    category: 'Food & Wine',
  ...
  },
  {
    ...
    price: 450,
    capacity: 500,
    description: 'The biggest pop culture event in Africa featuring cosplay, gaming, comics, and special guest appearances.',
    ageRestriction: 'All ages',
    category: 'Entertainment',
    image: 'https://images.unsplash.com/photo-1612036782180-6f0822045d23?auto=format&fit=crop&q=80',
    terms: [
  ...
  },
  {
    ...
    price: 950,
    capacity: 1000,
    description: 'Premier electronic music festival featuring top international DJs and spectacular production.',
    ageRestriction: '18+',
    category: 'Music',
            ...
            <div className="p-6">
              ...
              <div className="space-y-2 mb-4">
                <div className="flex items-center text-gray-600 text-sm">
                  ...
                  <span>{new Date(event.date).toLocaleDateString('en-ZA')} at {event.time}</span>
                </div>
                <div className="flex items-center text-gray-600 text-sm">
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <div className="text-sm text-gray-500">{event.ageRestriction}</div>
                </div>
            ...
            <div className="p-6">
              ...
              <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <div className="space-y-2 text-sm text-gray-600">
                      <div className="flex items-center">
                        <Calendar className="w-4 h-4 mr-2" />
                        <span>{new Date(selectedEvent.date).toLocaleDateString('en-ZA')}</span>
                      </div>
                      <div className="flex items-center">
                ...
                <div className="flex justify-between items-center pt-4 border-t">
                  <div>
                    <div className="text-2xl font-bold">{formatPrice(selectedEvent.price)}</div>
